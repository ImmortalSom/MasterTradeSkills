...
if lib.env.is_turtle_wow then
    ...
    module:NewCraft(999919, "Jade Harmony Circlet", 170, {SpellSource.Trainer})
        ...
        :Save()
    module:NewCraft(999918, "Gleaming Jade Gemstone", 175, {SpellSource.Trainer})
        :SetResult(56001)
        :AddReagent(1529, 1) -- Jade
    ...
    module:NewCraft(999917, "Goldenshade Quartz Crown", 175, {SpellSource.Trainer})
        ...
        :AddReagent(55249, 2) -- Crystal Quartz
        :Save()
    module:NewCraft(999916, "Powerful Citrine Pendant", 175, {SpellSource.Trainer})
        :SetResult(55147)
        :AddReagent(3575, 12) -- Iron Bar
    ...
    module:NewCraft(999915, "Rough Mithril Ring", 175, {SpellSource.Trainer})
        ...
        :Save()
    module:NewCraft(999914, "The Golden Goblet", 175, {SpellSource.Trainer})
        :SetResult(55146)
        :AddReagent(3577, 2) -- Gold Bar
    ...
    module:NewCraft(999912, "Ironsun Citrine Ring", 185, {SpellSource.Trainer})
        ...
        :AddReagent(55246, 1) -- Shimmering Oil
        :Save()
    module:NewCraft(999909, "Ironbloom Ring", 190, {SpellSource.Trainer})
        :SetResult(41342)
        :AddReagent(41332, 1) -- Rough Iron Ring
        :AddReagent(3575, 2) -- Iron Bar
